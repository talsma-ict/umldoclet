...
public abstract class PlantumlGenerator {
    ...
    public static PlantumlGenerator autodetect() {
        return new BuiltinPlantumlGenerator();
    }

    public abstract void generatePlantumlDiagramFromSource(String plantumlSource, FileFormat format, OutputStream out) throws IOException;

    private static final class BuiltinPlantumlGenerator extends PlantumlGenerator {
        @Override

...
public class UGraphicHtml5 extends AbstractUGraphic<Html5Drawer> implements ClipContainer {
	...
	//
	// final TextLayout t = new TextLayout("" + c, font.getFont(),
	// imDummy.getFontRenderContext());
	// getGraphicObject().setStrokeColor(getColorMapper().getMappedColor(getParam().getColor()));
	// DriverTextEps.drawPathIterator(getGraphicObject(), xpos + getTranslateX(),
	// ypos + getTranslateY(), t
	// .getOutline(null).getPathIterator(null));
	//
	// }
	//
	// static public String getEpsString(ColorMapper colorMapper, EpsStrategy
	// epsStrategy, UDrawable udrawable)
	// throws IOException {
	...
	// }
	//
	// static public void copyEpsToFile(ColorMapper colorMapper, UDrawable
	// udrawable, File f) throws IOException {

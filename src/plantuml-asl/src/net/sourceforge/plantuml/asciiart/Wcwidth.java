...
public class Wcwidth {
	 ...
	 */
	private static final int[][] COMBINING = { { 0x0300, 0x036F }, { 0x0483, 0x0486 }, { 0x0488, 0x0489 },
	 ...
	 *
	 * The following two functions define the column width of an ISO 10646 character
	 * as follows:
	 *
	 ...
	 *
	 * - Non-spacing and enclosing combining characters (general category code Mn or
	 * Me in the Unicode database) have a column width of 0.
	 *
	 ...
	 * category as defined in Unicode Technical Report #11 have a column width of 2.
	 *
	...
	public static int of(int codePoint) {
		...
		return 1 + ((codePoint >= 0x1100 && (codePoint <= 0x115f || // Hangul Jamo init. consonants
				...
				(codePoint >= 0xffe0 && codePoint <= 0xffe6) || (codePoint >= 0x20000 && codePoint <= 0x2fffd)
